...
public class UserPresenter extends RecyclerViewPresenter<Customer> {

    protected Adapter adapter;
    protected List<Customer> customers;

    public UserPresenter(Context context, List<Customer> customers) {
        super(context);
    ...
    class Adapter extends RecyclerView.Adapter<Adapter.Holder> {
        ...
        public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new Holder(LayoutInflater.from(getContext()).inflate(R.layout.user_autocomplete, parent, false));
        }
